<!-- <template>
    <div :class="(type === 'hidden') ? 'hidden' : ui.wrapper">
        <input :id="inputId" ref="input" :name="name" :type="type" :required="required" :placeholder="placeholder"
            :disabled="disabled" :class="inputClass" v-bind="type === 'file' ? attrs : { ...attrs, value: modelValue }"
...
<template>
    <div>
        <input :name="name" :type="type" :required="required" :placeholder="placeholder" :disabled="disabled"
            :value="modelValue" @input="onInput" @blur="onBlur" @change="onChange">
...
import { ref, computed, toRef, onMounted, defineComponent } from 'vue'
import { emits, type InputProps } from './config'
